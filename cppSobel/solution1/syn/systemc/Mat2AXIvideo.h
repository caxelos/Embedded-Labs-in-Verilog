...
struct Mat2AXIvideo : public sc_module {
    ...
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_exitcond_i_i_reg_268;
    sc_signal< sc_lv<6> > p_1_i_i_reg_162;
    sc_signal< sc_lv<6> > tmp_fu_173_p1;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<6> > tmp_1_fu_177_p1;
    sc_signal< sc_lv<6> > r_V_fu_181_p2;
    sc_signal< sc_lv<1> > exitcond1_i_i_fu_192_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<6> > i_V_fu_197_p2;
    sc_signal< sc_lv<6> > i_V_reg_263;
    ...
    sc_signal< sc_lv<6> > j_V_fu_208_p2;
    ...
    sc_signal< sc_lv<6> > p_i_i_reg_151;
