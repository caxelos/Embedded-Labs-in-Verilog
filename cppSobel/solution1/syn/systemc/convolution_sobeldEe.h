...
#ifndef __convolution_sobeldEe__HH__
#define __convolution_sobeldEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolution_sobeldEe) {
    ...
    SC_CTOR(convolution_sobeldEe):  simcore_mac_0_U ("simcore_mac_0_U") {
