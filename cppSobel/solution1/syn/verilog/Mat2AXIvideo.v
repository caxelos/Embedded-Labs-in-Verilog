...
reg   [0:0] ap_reg_pp0_iter1_exitcond_i_i_reg_268;
reg   [5:0] p_1_i_i_reg_162;
wire   [5:0] tmp_fu_173_p1;
reg    ap_block_state1;
wire   [5:0] tmp_1_fu_177_p1;
wire   [5:0] r_V_fu_181_p2;
wire   [0:0] exitcond1_i_i_fu_192_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [5:0] i_V_fu_197_p2;
reg   [5:0] i_V_reg_263;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_data_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_data_V_1_ack_out) & (OUTPUT_STREAM_V_data_V_1_state == 2'd3)) | ((1'b0 == OUTPUT_STREAM_V_data_V_1_vld_in) & (OUTPUT_STREAM_V_data_V_1_state == 2'd2)))) begin
            OUTPUT_STREAM_V_data_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_data_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_out) & (OUTPUT_STREAM_V_data_V_1_state == 2'd3)) | ((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_out) & (OUTPUT_STREAM_V_data_V_1_state == 2'd1)))) begin
            OUTPUT_STREAM_V_data_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_data_V_1_vld_in) & (OUTPUT_STREAM_V_data_V_1_state == 2'd2)) | ((1'b1 == OUTPUT_STREAM_V_data_V_1_ack_out) & (OUTPUT_STREAM_V_data_V_1_state == 2'd1)) | ((OUTPUT_STREAM_V_data_V_1_state == 2'd3) & ~((1'b1 == OUTPUT_STREAM_V_data_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_data_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_dest_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_dest_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_dest_V_1_state)))) begin
            OUTPUT_STREAM_V_dest_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_dest_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_dest_V_1_state)))) begin
            OUTPUT_STREAM_V_dest_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_dest_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_dest_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_dest_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_dest_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_dest_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_dest_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_id_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_id_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_id_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_id_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_id_V_1_state)))) begin
            OUTPUT_STREAM_V_id_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_id_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_id_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_id_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_id_V_1_state)))) begin
            OUTPUT_STREAM_V_id_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_id_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_id_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_id_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_id_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_id_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_id_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_id_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_id_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_keep_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_keep_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_keep_V_1_state)))) begin
            OUTPUT_STREAM_V_keep_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_keep_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_keep_V_1_state)))) begin
            OUTPUT_STREAM_V_keep_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_keep_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_keep_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_keep_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_keep_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_keep_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_keep_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_last_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_last_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_last_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_last_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_last_V_1_state)))) begin
            OUTPUT_STREAM_V_last_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_last_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_last_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_last_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_last_V_1_state)))) begin
            OUTPUT_STREAM_V_last_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_last_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_last_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_last_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_last_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_last_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_last_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_last_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_last_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_strb_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_strb_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_strb_V_1_state)))) begin
            OUTPUT_STREAM_V_strb_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_strb_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_strb_V_1_state)))) begin
            OUTPUT_STREAM_V_strb_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_strb_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_strb_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_strb_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_strb_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_strb_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_strb_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == OUTPUT_STREAM_V_user_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_user_V_1_ack_in))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b0 == OUTPUT_STREAM_V_user_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_user_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_user_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_user_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_user_V_1_state)))) begin
            OUTPUT_STREAM_V_user_V_1_state <= 2'd2;
        end else if ((((1'b1 == OUTPUT_STREAM_V_user_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_out) & (2'd3 == OUTPUT_STREAM_V_user_V_1_state)) | ((1'b0 == OUTPUT_STREAM_V_user_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_user_V_1_state)))) begin
            OUTPUT_STREAM_V_user_V_1_state <= 2'd1;
        end else if ((((1'b1 == OUTPUT_STREAM_V_user_V_1_vld_in) & (2'd2 == OUTPUT_STREAM_V_user_V_1_state)) | ((1'b1 == OUTPUT_STREAM_V_user_V_1_ack_out) & (2'd1 == OUTPUT_STREAM_V_user_V_1_state)) | ((2'd3 == OUTPUT_STREAM_V_user_V_1_state) & ~((1'b1 == OUTPUT_STREAM_V_user_V_1_vld_in) & (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_out)) & ~((1'b0 == OUTPUT_STREAM_V_user_V_1_vld_in) & (1'b1 == OUTPUT_STREAM_V_user_V_1_ack_out))))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in)) & (1'd1 == exitcond1_i_i_fu_192_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state3))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in)) & (1'd0 == exitcond1_i_i_fu_192_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd0 == exitcond_i_i_fu_203_p2))) begin
        p_1_i_i_reg_162 <= j_V_fu_208_p2;
    end else if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in)) & (1'd0 == exitcond1_i_i_fu_192_p2))) begin
        p_1_i_i_reg_162 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_i_i_reg_268) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == exitcond_i_i_fu_203_p2))) begin
        axi_last_V_reg_277 <= axi_last_V_fu_214_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in)))) begin
        i_V_reg_263 <= i_V_fu_197_p2;
    end
end

always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_i_i_reg_268)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_i_i_reg_268)))) begin
...
always @ (*) begin
    if ((1'd1 == exitcond_i_i_fu_203_p2)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in)) & (1'd1 == exitcond1_i_i_fu_192_p2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_i_i_reg_268))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_i_i_fu_203_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_i_i_fu_203_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign OUTPUT_STREAM_V_user_V_1_load_B = (OUTPUT_STREAM_V_user_V_1_sel_wr & OUTPUT_STREAM_V_user_V_1_state_cmp_full);
...
always @ (*) begin
    ap_block_pp0_stage0_flag00001001 = ((1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_i_i_reg_268) & (1'b0 == img_1_data_stream_0_empty_n));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011001 = (((1'b1 == ap_enable_reg_pp0_iter1) & (((1'd0 == exitcond_i_i_reg_268) & (1'b0 == img_1_data_stream_0_empty_n)) | (1'b1 == ap_block_state4_io))) | ((1'b1 == ap_enable_reg_pp0_iter2) & (1'b1 == ap_block_state5_io)));
end

always @ (*) begin
    ap_block_pp0_stage0_flag00011011 = (((1'b1 == ap_enable_reg_pp0_iter1) & (((1'd0 == exitcond_i_i_reg_268) & (1'b0 == img_1_data_stream_0_empty_n)) | (1'b1 == ap_block_state4_io))) | ((1'b1 == ap_enable_reg_pp0_iter2) & (1'b1 == ap_block_state5_io)));
end
...
always @ (*) begin
    ap_block_state2 = ((1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((1'd0 == exitcond_i_i_reg_268) & (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((1'd0 == exitcond_i_i_reg_268) & (1'b0 == img_1_data_stream_0_empty_n));
end

always @ (*) begin
    ap_block_state5_io = ((1'd0 == ap_reg_pp0_iter1_exitcond_i_i_reg_268) & (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in));
end
...
assign exitcond_i_i_fu_203_p2 = ((p_1_i_i_reg_162 == tmp_1_fu_177_p1) ? 1'b1 : 1'b0);

assign i_V_fu_197_p2 = (p_i_i_reg_151 + 6'd1);

assign j_V_fu_208_p2 = (p_1_i_i_reg_162 + 6'd1);

assign p_Result_s_fu_223_p3 = {{24'd16777215}, {img_1_data_stream_0_dout}};

assign r_V_fu_181_p2 = ($signed(tmp_1_fu_177_p1) + $signed(6'd63));

assign tmp_1_fu_177_p1 = cols[5:0];

assign tmp_fu_173_p1 = rows[5:0];
