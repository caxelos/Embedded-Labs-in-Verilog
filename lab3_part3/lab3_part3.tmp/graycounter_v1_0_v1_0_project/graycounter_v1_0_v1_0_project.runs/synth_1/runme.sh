...
HD_PWD='c:/users/user/desktop/lab3_customip/lab3_part3/lab3_part3.tmp/graycounter_v1_0_v1_0_project/graycounter_v1_0_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log graycounter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source graycounter_v1_0.tcl
