...
module bd_384c
  ...
  bd_384c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe1(net_slot_0_axi_arprot),
        .probe10(net_slot_0_axi_b_ctrl),
        .probe11(net_slot_0_axi_ar_ctrl),
        .probe12(net_slot_0_axi_r_ctrl),
        .probe2(net_slot_0_axi_awaddr),
        .probe3(net_slot_0_axi_awprot),
        .probe4(net_slot_0_axi_bresp),
        .probe5(net_slot_0_axi_rdata),
        .probe6(net_slot_0_axi_rresp),
        .probe7(net_slot_0_axi_wdata),
        .probe8(net_slot_0_axi_aw_ctrl),
        .probe9(net_slot_0_axi_w_ctrl));
