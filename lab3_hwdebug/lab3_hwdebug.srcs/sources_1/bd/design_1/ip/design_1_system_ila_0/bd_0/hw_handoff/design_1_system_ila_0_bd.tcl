...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SLOT_0_AXI_araddr [ create_bd_port -dir I -from 3 -to 0 SLOT_0_AXI_araddr ]
  set SLOT_0_AXI_arprot [ create_bd_port -dir I -from 2 -to 0 SLOT_0_AXI_arprot ]
  set SLOT_0_AXI_arready [ create_bd_port -dir I SLOT_0_AXI_arready ]
  set SLOT_0_AXI_arvalid [ create_bd_port -dir I SLOT_0_AXI_arvalid ]
  set SLOT_0_AXI_awaddr [ create_bd_port -dir I -from 3 -to 0 SLOT_0_AXI_awaddr ]
  set SLOT_0_AXI_awprot [ create_bd_port -dir I -from 2 -to 0 SLOT_0_AXI_awprot ]
  set SLOT_0_AXI_awready [ create_bd_port -dir I SLOT_0_AXI_awready ]
  set SLOT_0_AXI_awvalid [ create_bd_port -dir I SLOT_0_AXI_awvalid ]
  set SLOT_0_AXI_bready [ create_bd_port -dir I SLOT_0_AXI_bready ]
  set SLOT_0_AXI_bresp [ create_bd_port -dir I -from 1 -to 0 SLOT_0_AXI_bresp ]
  set SLOT_0_AXI_bvalid [ create_bd_port -dir I SLOT_0_AXI_bvalid ]
  set SLOT_0_AXI_rdata [ create_bd_port -dir I -from 31 -to 0 SLOT_0_AXI_rdata ]
  set SLOT_0_AXI_rready [ create_bd_port -dir I SLOT_0_AXI_rready ]
  set SLOT_0_AXI_rresp [ create_bd_port -dir I -from 1 -to 0 SLOT_0_AXI_rresp ]
  set SLOT_0_AXI_rvalid [ create_bd_port -dir I SLOT_0_AXI_rvalid ]
  set SLOT_0_AXI_wdata [ create_bd_port -dir I -from 31 -to 0 SLOT_0_AXI_wdata ]
  set SLOT_0_AXI_wready [ create_bd_port -dir I SLOT_0_AXI_wready ]
  set SLOT_0_AXI_wvalid [ create_bd_port -dir I SLOT_0_AXI_wvalid ]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_ar_ctrl [get_bd_pins ila_lib/probe11] [get_bd_pins slot_0_ar/dout]
  connect_bd_net -net net_slot_0_axi_araddr [get_bd_pins g_inst/m_slot_0_axi_araddr] [get_bd_pins ila_lib/probe0]
  connect_bd_net -net net_slot_0_axi_arprot [get_bd_pins g_inst/m_slot_0_axi_arprot] [get_bd_pins ila_lib/probe1]
  ...
  connect_bd_net -net net_slot_0_axi_aw_ctrl [get_bd_pins ila_lib/probe8] [get_bd_pins slot_0_aw/dout]
  connect_bd_net -net net_slot_0_axi_awaddr [get_bd_pins g_inst/m_slot_0_axi_awaddr] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net net_slot_0_axi_awprot [get_bd_pins g_inst/m_slot_0_axi_awprot] [get_bd_pins ila_lib/probe3]
  ...
  connect_bd_net -net net_slot_0_axi_b_ctrl [get_bd_pins ila_lib/probe10] [get_bd_pins slot_0_b/dout]
  connect_bd_net -net net_slot_0_axi_bready [get_bd_pins g_inst/m_slot_0_axi_bready] [get_bd_pins slot_0_b/In1]
  connect_bd_net -net net_slot_0_axi_bresp [get_bd_pins g_inst/m_slot_0_axi_bresp] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net net_slot_0_axi_bvalid [get_bd_pins g_inst/m_slot_0_axi_bvalid] [get_bd_pins slot_0_b/In0]
  connect_bd_net -net net_slot_0_axi_r_ctrl [get_bd_pins ila_lib/probe12] [get_bd_pins slot_0_r/dout]
  connect_bd_net -net net_slot_0_axi_rdata [get_bd_pins g_inst/m_slot_0_axi_rdata] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_0_axi_rready [get_bd_pins g_inst/m_slot_0_axi_rready] [get_bd_pins slot_0_r/In1]
  connect_bd_net -net net_slot_0_axi_rresp [get_bd_pins g_inst/m_slot_0_axi_rresp] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net net_slot_0_axi_rvalid [get_bd_pins g_inst/m_slot_0_axi_rvalid] [get_bd_pins slot_0_r/In0]
  connect_bd_net -net net_slot_0_axi_w_ctrl [get_bd_pins ila_lib/probe9] [get_bd_pins slot_0_w/dout]
  connect_bd_net -net net_slot_0_axi_wdata [get_bd_pins g_inst/m_slot_0_axi_wdata] [get_bd_pins ila_lib/probe7]
