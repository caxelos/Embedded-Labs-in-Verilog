...
HD_PWD='/home/trakaros/tou_nikou/lab5_hw_hls/lab5_hw_hls.tmp/ip_sobel_v1_0_project/ip_sobel_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_sobel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_sobel.tcl
