...
HD_PWD='/home/trakaros/tou_nikou/lab5_hw_hls/lab5_hw_hls.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_5_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_5_wrapper.tcl -notrace
