...
HD_PWD='/home/trakaros/tou_nikou/lab5_hw_hls/lab5_hw_hls.runs/project_5_ip_sobel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_5_ip_sobel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_5_ip_sobel_0_0.tcl
