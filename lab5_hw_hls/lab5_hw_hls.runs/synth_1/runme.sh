...
HD_PWD='/home/trakaros/tou_nikou/lab5_hw_hls/lab5_hw_hls.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_5_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_5_wrapper.tcl
