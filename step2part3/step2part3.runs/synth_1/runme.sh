...
HD_PWD='/home/trakaros/tou_nikou/step2part3/step2part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_multiplication.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_multiplication.tcl
