...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name ip_sobel_ap_uitodp_4_no_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type custom \
                          ...
                          CONFIG.component_name ip_sobel_ap_uitodp_4_no_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips ip_sobel_ap_uitodp_4_no_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files ip_sobel_ap_uitodp_4_no_dsp_32.xci]
generate_target {synthesis simulation} [get_files ip_sobel_ap_uitodp_4_no_dsp_32.xci]
