...
#ifndef __ip_sobel_uitodp_3eOg__HH__
#define __ip_sobel_uitodp_3eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_sobel_uitodp_3eOg) {
    ...
    SC_CTOR(ip_sobel_uitodp_3eOg):  ACMP_uitodp_U ("ACMP_uitodp_U") {
