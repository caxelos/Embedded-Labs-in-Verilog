...
#ifndef __ip_sobel_mul_8ns_bkb__HH__
#define __ip_sobel_mul_8ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_sobel_mul_8ns_bkb) {
    ...
    SC_CTOR(ip_sobel_mul_8ns_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
