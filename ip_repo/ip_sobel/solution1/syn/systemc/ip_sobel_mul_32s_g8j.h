...
#ifndef __ip_sobel_mul_32s_g8j__HH__
#define __ip_sobel_mul_32s_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_sobel_mul_32s_g8j) {
    ...
    SC_CTOR(ip_sobel_mul_32s_g8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
