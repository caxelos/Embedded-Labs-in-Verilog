...
#ifndef __ip_sobel_dsqrt_64fYi__HH__
#define __ip_sobel_dsqrt_64fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ip_sobel_dsqrt_64fYi) {
    ...
    SC_CTOR(ip_sobel_dsqrt_64fYi):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
