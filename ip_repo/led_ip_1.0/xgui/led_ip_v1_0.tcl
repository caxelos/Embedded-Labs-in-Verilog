...
proc update_PARAM_VALUE.ADDR_LSB { PARAM_VALUE.ADDR_LSB } {
	# Procedure called to update ADDR_LSB when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADDR_LSB { PARAM_VALUE.ADDR_LSB } {
	# Procedure called to validate ADDR_LSB
	return true
}
...
proc update_MODELPARAM_VALUE.ADDR_LSB { MODELPARAM_VALUE.ADDR_LSB PARAM_VALUE.ADDR_LSB } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADDR_LSB}] ${MODELPARAM_VALUE.ADDR_LSB}
}
