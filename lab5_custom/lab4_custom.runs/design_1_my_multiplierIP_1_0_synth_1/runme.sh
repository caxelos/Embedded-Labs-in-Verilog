...
HD_PWD='/home/trakaros/tou_nikou/lab5_custom/lab4_custom.runs/design_1_my_multiplierIP_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_multiplierIP_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_multiplierIP_1_0.tcl
