...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra -g -pg
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = my_multiplierIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = my_multiplierIP_1
END
