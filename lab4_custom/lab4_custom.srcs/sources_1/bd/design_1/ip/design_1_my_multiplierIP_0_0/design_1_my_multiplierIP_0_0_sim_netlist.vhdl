...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_my_multiplierIP_0_0_mult_testbench is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_my_multiplierIP_0_0_mult_testbench : entity is "mult_testbench";
end design_1_my_multiplierIP_0_0_mult_testbench;

architecture STRUCTURE of design_1_my_multiplierIP_0_0_mult_testbench is
...
mutt_testbench_inst: entity work.design_1_my_multiplierIP_0_0_mult_testbench
     port map (
      Q(0) => p_2_in(0),
      TRIGGER => TRIGGER,
      s00_axi_aclk => s00_axi_aclk,
